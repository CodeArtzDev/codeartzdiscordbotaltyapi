...
exports.run = async (client, message, params) => {
  ...
  .setTitle("» Code Bot | Canlı Destek")
  .setDescription("**Canlı Desteği kullandğın için teşekkür ederiz, Seninle ekibim ilgilenicektir lütfen bekle!**")
  .setFooter("30 Saniye içinde geri dönülmezse lütfen iletişime geçin <@690918038463184908>")
 message.channel.send(embed)
      const invite = new Discord.RichEmbed()
  .setAuthor("» Code Bot Canlı Destek | Talep")
